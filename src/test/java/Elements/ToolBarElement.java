...
public class ToolBarElement
{
    ...
    private static final By MUSIC_BUTTON = By.xpath(".//div[data-l=\"t,music\"]");
    ...
    public ToolBarElement(){checkPage();}
    public MusicPage openMusic() {
        $(MUSIC_BUTTON).shouldBe(visible.because("Should be visible to open music")).click();
        return new MusicPage();
    }

    public void checkPage() {
        $(MUSIC_BUTTON).shouldBe(visible.because("Should be visible to open music"));
